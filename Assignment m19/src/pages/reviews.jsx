...
const ReviewsPage = () => {
	const reviewsData = [
		...
		},
		{
			...
			content:
				'Nullam hendrerit cursus felis, vel tincidunt neque varius at. Vestibulum quis libero vel tellus posuere tincidunt.',
			author: 'Jane Smith',
			rating: 4,
		},
		{
			...
			<div className="max-w-4xl mx-auto">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
					{reviewsData.map((review) => (
						<div
							key={review.id}
							className="bg-orange-100 p-6 rounded-md shadow-md">
