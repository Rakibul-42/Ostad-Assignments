		...
		<div className="container mx-auto mt-8  p-4">
			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
				<div className="mt-2 shadow-md rounded-md hover:border-black hover:border-collapse border-2 w-fit  p-2">
					...
					<p className="mt-2">
						Email:{' '}
						<a href="mailto:support@pemons.com">
							support@pemons.com
						</a>
					</p>
				</div>
				...
				<div className="mt-2 shadow-md rounded-md hover:border-black hover:border-collapse border-2 w-fit  p-2">
					...
					<p>
						For business-related inquiries, partnerships, or
						collaboration opportunities, please contact us.
					</p>
					<p className="mt-2">
						Email:{' '}
						<a href="mailto:business@pemons.com">
							business@pemons.com
						</a>
					</p>
				</div>
			...
			<div className="mt-8 shadow-md rounded-md hover:border-black hover:border-collapse border-2 w-fit  p-2">
				...
				<p>
					Feel free to visit our office during business hours. Our
					address is:
				</p>
				<p className="mt-2">
					123 Market Street, City ville, State, ZIP
				</p>
			</div>
		</div>
	);
