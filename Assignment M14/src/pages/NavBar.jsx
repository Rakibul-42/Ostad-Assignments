...
const NavBar = (props) => {
    ...
    return (
        ...
        <>
            <div className="navbar bg-black fixed top-0 z-50 ">
                <div className="navbar-start">
                    ...
                    <a className="btn btn-ghost normal-case text-xl text-white">Design<span className='text-green-500'>AGENCY</span></a>
                </div>
