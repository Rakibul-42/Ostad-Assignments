    ...
    return (
        <div className='container p-10'>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 p-4 my-8">
                {cardData.map((data) => (
                    <div key={data.id} className="bg-black p-6 ">
                        <div className="text-2xl mb-4 bg-blue-200 p-4 w-16 rounded">
                            <span role="img" aria-label="Icon 1">
                                {data.icon}
                            </span>
                        </div>
                        <h2 className="text-xl font-bold mb-2">{data.heading}</h2>
                        <p className="text-white-600 mb-4">{data.des}</p>
            ...
            {smallCardData.map((data) => (
                <div key={data.id} className="bg-black p-10 rounded-lg shadow-md text-center flex flex-col items-center ">
                    <div className="text-4xl mb-4 bg-gray-200 p-5 rounded-md">{data.icon}</div>
